  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "fc_amount", label: "Amount", tdClass: "text-right" },
        ...
        { key: "open_amount", label: "Outstanding Amount", tdClass: "text-right" },
        { key: "open_amount_per", label: "Outstanding %", tdClass: "text-right", thClass: "text-right" },
      ],
      infoModal: {
        id: "info-modal",
        title: "",
